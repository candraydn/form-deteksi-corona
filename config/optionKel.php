...
$sql = $con->prepare("SELECT * FROM villages WHERE district_id = '".$id_kec."' ORDER BY name");
...
$callback = array('data_kel'=>$html); // Masukan variabel html tadi ke dalam array $callback dengan index array : data_kota
